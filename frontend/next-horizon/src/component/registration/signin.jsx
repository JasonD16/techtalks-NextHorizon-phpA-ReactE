...
export default function Signin() {  
  ...
  return (
          ...
          <div className="container">
            <div className="form">
              <h1 style={{fontFamily: "Alegreya", fontWeight: "bold"}}>SIGN IN</h1>
              <form action="">
              ...
              <div className="google-sign-in-container">
                ...
                <button className="google-button">
                  ...
                  <b></b>Sign in by Google
                </button>
              </div>
              <p><b>Don't have an account?</b> <a href="/register" style={{ color: "blue" }}>Register</a></p> <br />
            </div>
          </div> 
  )
}
